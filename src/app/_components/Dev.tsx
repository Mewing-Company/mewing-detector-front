  ...
  return (
    <div className="w-auto h-auto flex flex-col justify-center items-center relative">
      <User
        ...
        classNames={{ description: "text-[#a855f7]", name: "text-[#ebf6ff]/70" }}
        key={props.name}
      />

      <div className="inline-flex justify-center items-center overflow-default">
        <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
          <li className="mr-5 text-xs shrink-0">
            <a className="block text-slate-500/40 hover:text-slate-400" href={props.github} target="_blank" title="GitHub">
          ...
          <li className="mr-5 text-xs shrink-0">
            <a
              className="block text-slate-500/40 hover:text-slate-400"
              href={props.github}
              target="_blank"
